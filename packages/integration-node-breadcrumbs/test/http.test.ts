// TODO: This tests have to be reworked to _not_ depend on the Client package
...
// import { HTTPBreadcrumbs } from '../src/http';
...
//         integrations: [new HTTPBreadcrumbs({ tracing: true })],
//       }),
//     );
//     addExtensionMethods();
