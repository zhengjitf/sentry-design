...
// TODO: Rework these tests after transports are
describe('FetchTransport', () => {
  ...
  describe('sendRequest()', () => {
    it('sends a request to Sentry servers', async () => {
      fetchMock.mockImplementationOnce((_url, _options) => {
      ...
      expect(fetch).toHaveBeenCalledWith(envelopeUrl, {
        body: expect.stringMatching('\\"event_id\\":\\"1337\\"'),
        method: 'POST',
